    ...
    >
      ...
      <div className="flex flex-col items-center mt-[80px]">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-[18px] mt-[8px] font-urbanist font-semibold text-[#2D3436]">
            Your Lovely Name
          </p>
          <input
            type="text"
          ...
          <div className="flex justify-center items-center mt-[10px]">
            <input
              ...
              className="w-60 h-60"
            />
            <label className="text-[16px] font-urbanist ml-[5px] mr-[10px]">
              Trainer
            </label>
          ...
          <div
            className="flex justify-center items-center bg-[#FF7675] font-urbanist rounded-[15px] w-[360px] h-[61px] text-[22px] mt-[15px]"
            style={{ boxShadow: "0px 12px 26px rgba(255, 118, 117, 0.30)" }}
          >
            <div
